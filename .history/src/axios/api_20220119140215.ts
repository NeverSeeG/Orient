...
class api {
  ...
  public static common = {
    ...
    userList: (params?: any) => Request.get("/api/user/listByFilter.rdm",params),
    userCreate:(params?: any)=> Request.formData("/api/user/create.rdm", params),
    userUpdate:(params?: any)=> Request.formData("/api/user/update.rdm", params),
    ...
    saveRole: (params?: any) =>Request.formData("/api/role/create.rdm", params),
    updateRole: (params?: any) =>Request.formData("/api/role/update.rdm", params),
    listUsers: (params?:any) => Request.get("/api/role/listUsers.rdm", params),
    saveAssignUsers:(params?:any) => Request.formData("/api/role/saveAssignUsers.rdm",params),
    ...
    // 获取角色功能点
    treeRoleFunctions:(params?: any) => Request.get("/api/role/treeRoleFunctions.rdm",params),
    // 角色分配功能点
    saveAssignFunctions: (params?: any) =>Request.formData("/api/role/saveAssignFunctions.rdm",params),
    // 获取所有功能点
  ...
  public static EnumCombobox = {
    getEnumCombobox: (params?: any) =>Request.get("/api/orientForm/getEnumCombobox.rdm",params),
    // 角色分配功能点
  };
