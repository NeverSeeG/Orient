...
class api {
  ...
  public static common = {
    ...
    // 获取所有功能点
    getFuncById: (params?:any) => Request.get("/api/func/getByPid.rdm",params),
    // 创建功能点
    createFunc: (params?: any)=> Request.post("/api/func/create",params)
  };
  ...
  public static  ship = {
    ...
    importData: (params?:any,data?:any) => Request.customer("/api/gasImport/importEquipParasData.rdm",params,data),
    deleteData: (params?:any) => Request.get("/api/gasShip/deleteShipData.rdm",params)
  }
}
