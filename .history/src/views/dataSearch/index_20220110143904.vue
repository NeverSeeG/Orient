...
// 查询
const query = () => {
  let equipIds = proxy.$refs.tree.getCheckedKeys();
  let paraIds = proxy.$refs.paramsTree.getCheckedKeys()

  console.log("queryForm.equipment",queryForm.equipment);
  console.log("queryForm.equipmentParams",queryForm.equipmentParams);
  console.log("查询");
  let params = {
    no: queryForm.no,
    equipId: shipMap[equipIds],
    paraIds: paraIds.join(";"),
