<template>
  <el-scrollbar style="height: 100%">
    <div class="main">
      ...
      <div>
        <el-table highlight-current-row v-for="(table,index) in dataInfo.tableData" :data="table.tableData" :key="index" border fit style="width: 100%">
            <el-table-column prop="name" label="单位名称"  /></el-table>
        </el-table>
      </div>
    </div>
  </el-scrollbar>
