...
const saveData = () => {
  formRef.value.validate((valid) => {
    if (valid) {
      ...
      params.functionid = "";
      params.parentid = funcState.form.functionid || funcState.form.id;
      params.results = [];
      if (params.hasOwnProperty("id")) {
        delete params.id;
      }
      console.log("params", params);
      api.common.createFunc(params).then((data: any) => {
...
const editData = () => {
  formRef.value.validate((valid: boolean) => {
    if (valid) {
      let params = cloneDeep(funcState.form);
      params.functionid = funcState.form.id || funcState.form.functionid;
      params.parentid = funcState.form.pid || funcState.form.parentid;
      if (params.hasOwnProperty("id")) {
        delete params.id;
      }
      ...
      api.common.updateFunc(params).then((data: any) => {
        console.log("data", data);
        if (data.success) {
          getList();
        }
