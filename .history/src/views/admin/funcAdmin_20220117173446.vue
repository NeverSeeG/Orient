...
const saveData = () => {
  // funcState.form.id=''
  // funcState.form.pid = nodeClickData.id
  // funcState.form.results = []
  let params = cloneDeep(funcState)
  params.form.id=''
  params.form.pid=funcState.form.id
  params.form.results=[]
  api.common.createFunc(params.form).then((data: any) => {
    console.log("data", data);
  });
};
const editData = () => {
  let params = Object.assign({},nodeClickData,funcState.form )
