  ...
  <div class="main">
    <div class="content">
      ...
      <div class="table_body" ref="tableBody">
        <el-table highlight-current-row default-expand-all  row-key="id" :data="tableData" :tree-props="{ children: 'children', hasChildren: 'hasChildren' }" border fit style="width: 100%" :height="tableMaxHeight"   :header-cell-style="{background:'#19346B',fontSize: '14px',color:'#FFFFFF'}" :row-style="{background: '#131E3C',fontSize: '14px',color:'#FFFFFF'}">
