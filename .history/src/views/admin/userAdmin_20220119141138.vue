      ...
      <el-row class="row-flex">
        ...
        ><el-col :span="12">
          <el-form-item label="职务" prop="post">
            <el-input v-model="dialogState.form.post" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
...
// 获取枚举值
const getEnumCombobox=()=>{
  api.EnumCombobox.getEnumCombobox(params).then((data:{ results:EnumCombobox;} )=>{

  })
}
const options = reactive([
  { id: "C4CA4238A0B923820DCC509A6F75849B", value: "机密" },
  { id: "C81E728D9D4C2F636F067F89CC14862C", value: "秘密" },
  { id: "ECCBC87E4B5CE2FE28308FD9F2A7BAF3", value: "内部" },
  { id: "E4DA3B7FBBCE2345D7772B0674A318D5", value: "公开" },
]);
const getTreeList = () => {
