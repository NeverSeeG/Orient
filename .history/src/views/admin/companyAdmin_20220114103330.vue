      ...
      <el-row class="row-flex">
        ...
        <el-col :span="12">
          <el-form-item label="备注">
            <el-input v-model="detailForm.notes" /> </el-form-item
        ></el-col>
      </el-row>
    </el-form>
    <template #footer>
...
const saveData = () => {
  if (crudStatus.value === "add") {
    detailForm.value.pid = pid;
    api.common.saveDept(detailForm.value).then((data: any) => {
      console.log('data',data);
      if(data.success){
      ...
      api.common.updateDept(detailForm.value).then((data: any) => {
      console.log('data',data);
      if(data.success){
        ElMessage.success(data.msg)
        getDeptList()
...
const deleteRow=(id: string) => {
  //  api.common.deleteDept({toDelIds:id}).then((data: any) => {
  //     if(data.success){
  //       ElMessage.success(data.msg)
  //       getDeptList()
  //     }
