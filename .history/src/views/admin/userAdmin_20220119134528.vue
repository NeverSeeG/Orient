      ...
      <el-row class="row-flex">
        ...
        <el-col :span="12">
          <el-form-item label="生日" prop="birthday" >
            <el-date-picker style="width:100%" type="date"  v-model="dialogState.form.birthday" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
        ...
        <el-col :span="12">
          <el-form-item label="备注" prop="notes">
            <el-input v-model="dialogState.form.notes" type="textarea" :autosize="{ minRows: 2, maxRows: 4 }"/>
          </el-form-item> </el-col
        >
      </el-row>
    </el-form>
