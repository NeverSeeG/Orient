  ...
  <div class="main">
    <div class="content">
      ...
      <div class="userContent">
        ...
        <div class="operate_area">
          <el-button type="primary" size="small" title="分配用户" @click="assignTable" :icon="ArrowRight"></el-button>
          <el-button type="primary" size="small" title="取消分配" @click="unassignTable" :icon="ArrowLeft"></el-button>
        </div>
        <div class="leftTable">
          <el-table
            highlight-current-row
