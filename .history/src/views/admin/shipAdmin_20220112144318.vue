        ...
        >
          ...
          <el-table-column fixed="left" label="操作" width="350">
            <template #default="scope">
              <el-button type="text" size="small" :icon="Edit" @click="editRow(scope.row)"
                >编辑</el-button
              >
      ...
      <el-row class="row-flex">
        ...
        <el-col :span="12">
          <el-form-item label="船籍国">
            <el-input
              v-model="detailForm.registryCountry"
            ></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="船籍港">
            <el-input
              v-model="detailForm.registryHarbor"
            ></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
