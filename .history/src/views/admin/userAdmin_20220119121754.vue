      ...
      <el-row class="row-flex">
        ...
        <el-col :span="12">
          <el-form-item label="生日" prop="birthday">
            <el-input v-model="dialogState.form.birthday" disabled />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="电话" prop="phone">
            <el-input v-model="dialogState.form.phone" disabled />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="手机号码" prop="mobile">
            <el-input v-model="dialogState.form.mobile" disabled />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="邮箱" prop="email">
            <el-input v-model="dialogState.form.email" disabled />
          </el-form-item>
        </el-col><el-col :span="12">
          <el-form-item label="职务" prop="post">
            <el-input v-model="dialogState.form.post" disabled />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="性别" prop="grade">
            <el-input v-model="dialogState.form.grade" disabled />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="备注" prop="notes">
            <el-input v-model="dialogState.form.notes" disabled />
          </el-form-item>
        </el-col>sex: 
      </el-row>
    </el-form>
