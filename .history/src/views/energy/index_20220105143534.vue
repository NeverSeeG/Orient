    ...
    <div class="main">
       <div class="search">
        ...
        <div class="query_form">
         ...
         <el-select v-model="formInline.name" clearable placeholder="Select" style="width:200px;margin-right: 8px;">
            <el-option
          ...
          <span style="color:#00CCFF;font-size: 14px;margin-right: 16px;">航次:</span>
          <el-input style="width:200px;margin-right: 8px;"> v-model="formInline.voyage" placeholder="请输入当前船舶名称"></el-input>
