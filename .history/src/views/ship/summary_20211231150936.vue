    ...
    <div class="main">
      ...
      <div class="content" >
        <div style="height:100%" ref="tableBody">
          <el-table :data="tableData" fit style="width: 90%" :height="tableMaxHeight"   :header-cell-style="{background:'#19346B',fontSize: '14px',color:'#FFFFFF'}" :row-style="{background: '#131E3C',fontSize: '14px',color:'#FFFFFF'}">
