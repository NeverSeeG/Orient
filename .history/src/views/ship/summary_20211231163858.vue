    ...
    <div class="main">
      <div class="search">
        ...
        <div class="query_form">
          <el-form :inline="true" :model="formInline" style="height:48px">
            <el-form-item label="当前船舶:">
              <el-input v-model="formInline.name" placeholder="请输入当前船舶名称"></el-input>
            </el-form-item>
              <el-button type="primary" size="default" @click="query" :icon="Search">查询</el-button>
              <el-button color="#00CCFF" plain style="color: #00CCFF" size="default" @click="queryAll" :icon="SetUp">查询全部</el-button>
          </el-form>
        </div>
      </div>
      <div class="content" >
