      ...
      <el-row class="row-flex">
        <el-col :span="12">
          <el-form-item label="载货量(t)">
            <el-input
              v-model="dataInfo.detailForm.BOATLOAD_4127"
              style="color: black"
            ></el-input>
          </el-form-item>
        </el-col>
        ...
        <el-col :span="12">
          <el-form-item label="IMO NO">
            <el-input
              v-model="dataInfo.detailForm.IMO_NO_4127"
            /> </el-form-item
        ></el-col>
        <el-col :span="12">
        ...
        <el-col :span="12">
          <el-form-item label="船籍国">
            <el-input
              v-model="dataInfo.detailForm.REGISTRY_COUNTRY_4127"
            ></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="船籍港">
            <el-input
              v-model="dataInfo.detailForm.REGISTRY_HARBOR_4127"
            ></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
