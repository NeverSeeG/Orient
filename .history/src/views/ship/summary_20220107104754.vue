    ...
    <div class="main">
      <div class="search">
        ...
        <div class="query_form">
          <span style="color: #00ccff; font-size: 14px; margin-right: 8px"
            >当前船舶:</span
          >
          <el-input style="width: 200px; margin-right: 8px"
            v-model="no" placeholder="请输入当前船舶名称"></el-input
          >
      ...
      <div class="content">
        ...
        <div style="height: calc(100% - 40px); margin-top: 8px" ref="tableBody">
          ...
          >
            <el-table-column prop="date" label="船舶代号" width="150" />
            <el-table-column prop="name" label="船舶名称" />
            <el-table-column prop="address" label="航线" />
            <el-table-column prop="address" label="航次" />
            <el-table-column prop="address" label="状态" />
            <el-table-column prop="address" label="吃水" />
            <el-table-column prop="address" label="航速" />
          </el-table>
        </div>
      </div>
      <div class="map">
...
const getList = (params: any) => {
  api.shipSummary.list(params).then((data) => {
    if (data) {
