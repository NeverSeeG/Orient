...
<template>
  ...
  <el-dialog v-model="dialogVisible" title="详情" width="30%">
      <el-form ref="formRef" disabled v-model="dataInfo.detailForm" label-width="120px">
        <el-form-item label="载货量(t)">
          <el-input v-model="dataInfo.detailForm.BOATLOAD_4127" style="color:black"></el-input>
        </el-form-item>
        <el-form-item label="CCS登记号">
          <el-input v-model="dataInfo.detailForm.CCS_REGISTER_NUM_4127" />
        </el-form-item>
        <el-form-item label="设计航速(km)">
          <el-input v-model="dataInfo.detailForm.DESIGN_SPEED_4127" />
        </el-form-item>
        <el-form-item label="IMO NO">
          <el-input v-model="dataInfo.detailForm.IMO_NO_4127" />
        </el-form-item>
        <el-form-item label="船舶名称">
          <el-input v-model="dataInfo.detailForm.NAME_4127"></el-input>
        </el-form-item>
        <el-form-item label="船舶代号">
          <el-input v-model="dataInfo.detailForm.NO_4127"></el-input>
        </el-form-item>
        <el-form-item label="船籍国">
          <el-input v-model="dataInfo.detailForm.REGISTRY_COUNTRY_4127"></el-input>
        </el-form-item>
        <el-form-item label="船籍港">
          <el-input v-model="dataInfo.detailForm.REGISTRY_HARBOR_4127"></el-input>
        </el-form-item>
        <el-form-item label="螺距(mm)">
          <el-input v-model="dataInfo.detailForm.SCREW_PITCH_4127"></el-input>
        </el-form-item>
        <el-form-item label="船型">
          <el-input v-model="dataInfo.detailForm.SHIP_TYPE_4127"></el-input>
        </el-form-item>
        <el-form-item label="船舶单位">
          <el-input v-model="dataInfo.detailForm.UNIT_4127"></el-input>
        </el-form-item>
      </el-form>
    <template #footer>
...
const detail = (row: { ShipName: String; ShipNo: String }) => {
  ...
  api.shipSummary.getShipDetailsForNameAndNo(params).then((data: any) => {
    if (data && data instanceof Array && data.length > 0) {
      dataInfo.detailForm = data[0];
      dialogVisible.value = true;
      console.log("dataInfo.detailForm", dataInfo.detailForm);
    } else {
