          ...
          >
            ...
            <el-table-column fixed="right" label="操作" width="200">
              <template #default="scope">
                <el-button type="text" size="small" :icon="View" @click="detail(scope.row)"
                  >详情</el-button
                >
              </template>
            </el-table-column>
...
const detail = (row: { ShipName: any; ShipNo: any; }) => {
  console.log('row',row)
  console.log('name',row.ShipName)
  console.log('no',row.ShipNo)
  api.shipSummary.getShipDetailsForNameAndNo({name:row.ShipName,no:row.ShipNo}).then((data: any) => {
    if(data){
